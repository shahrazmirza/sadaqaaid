      ...
      <Container>
        <div className='md:flex'>
          ...
          >
            ...
            <Link href="/" className='text-l/snug font-normal text-gray-700 leading-10'>Home</Link>
            <Link href="/Ramadan" className='text-l/snug font-normal text-gray-500 leading-10'>Ramadan</Link>
            {/* <Link href="/" className='text-l/snug font-normal text-gray-500 leading-10'>About</Link> */}
            <Link href="/Appeals" className='text-l/snug font-normal text-gray-500 leading-10'>Appeals</Link>
            <Link href="/Projects" className='text-l/snug font-normal text-gray-500 leading-10'>Projects</Link>
            <Link href="/Sadaqa" className='text-l/snug font-normal text-gray-500 leading-10'>Sadaqa</Link>
            <Link href="/Zakat" className='text-l/snug font-normal text-gray-500 leading-10'>Zakat</Link>
          </motion.div>
          ...
          >
            ...
            <Link href="/Contact" className='text-l/snug font-normal text-gray-700 leading-10'>Contact us</Link>
              ...
              <div className='flex justify-center items-center'>
                ...
                <p className='text-l/snug font-normal text-gray-500 leading-10'>info@sadaqaaid.org.au</p>
              </div>
