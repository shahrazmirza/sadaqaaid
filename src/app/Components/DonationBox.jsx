  ...
  return (
    <Container>
      <div className='md:flex h-screen items-center md:gap-20 md:p-10'>
        <h1 className='wrap font-heading1 text-2xl py-10 md:text-5xl text-white text-center md:text-start drop-shadow-2xl p-5 md:p-0 animate__animated animate__fadeIn animate__delay-1s'>Join our movement with Sadaqa Aid to end poverty and transform lives globally</h1>
